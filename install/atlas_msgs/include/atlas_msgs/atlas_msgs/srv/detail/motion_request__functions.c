...
atlas_msgs__srv__MotionRequest_Request__create()
{
  ...
  atlas_msgs__srv__MotionRequest_Request * msg = (atlas_msgs__srv__MotionRequest_Request *)allocator.allocate(sizeof(atlas_msgs__srv__MotionRequest_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(atlas_msgs__srv__MotionRequest_Request));
  bool success = atlas_msgs__srv__MotionRequest_Request__init(msg);
  if (!success) {
...
atlas_msgs__srv__MotionRequest_Request__destroy(atlas_msgs__srv__MotionRequest_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    atlas_msgs__srv__MotionRequest_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
atlas_msgs__srv__MotionRequest_Request__Sequence__init(atlas_msgs__srv__MotionRequest_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  atlas_msgs__srv__MotionRequest_Request * data = NULL;

  if (size) {
    data = (atlas_msgs__srv__MotionRequest_Request *)allocator.zero_allocate(size, sizeof(atlas_msgs__srv__MotionRequest_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = atlas_msgs__srv__MotionRequest_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        atlas_msgs__srv__MotionRequest_Request__fini(&data[i - 1]);
      }
...
atlas_msgs__srv__MotionRequest_Request__Sequence__fini(atlas_msgs__srv__MotionRequest_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      atlas_msgs__srv__MotionRequest_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  atlas_msgs__srv__MotionRequest_Request__Sequence * array = (atlas_msgs__srv__MotionRequest_Request__Sequence *)allocator.allocate(sizeof(atlas_msgs__srv__MotionRequest_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = atlas_msgs__srv__MotionRequest_Request__Sequence__init(array, size);
  if (!success) {
...
atlas_msgs__srv__MotionRequest_Request__Sequence__destroy(atlas_msgs__srv__MotionRequest_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    atlas_msgs__srv__MotionRequest_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
atlas_msgs__srv__MotionRequest_Request__Sequence__are_equal(const atlas_msgs__srv__MotionRequest_Request__Sequence * lhs, const atlas_msgs__srv__MotionRequest_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!atlas_msgs__srv__MotionRequest_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  atlas_msgs__srv__MotionRequest_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(atlas_msgs__srv__MotionRequest_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    atlas_msgs__srv__MotionRequest_Request * data =
      (atlas_msgs__srv__MotionRequest_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!atlas_msgs__srv__MotionRequest_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          atlas_msgs__srv__MotionRequest_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!atlas_msgs__srv__MotionRequest_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  atlas_msgs__srv__MotionRequest_Response * msg = (atlas_msgs__srv__MotionRequest_Response *)allocator.allocate(sizeof(atlas_msgs__srv__MotionRequest_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(atlas_msgs__srv__MotionRequest_Response));
  bool success = atlas_msgs__srv__MotionRequest_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
atlas_msgs__srv__MotionRequest_Response__destroy(atlas_msgs__srv__MotionRequest_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    atlas_msgs__srv__MotionRequest_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
atlas_msgs__srv__MotionRequest_Response__Sequence__init(atlas_msgs__srv__MotionRequest_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  atlas_msgs__srv__MotionRequest_Response * data = NULL;

  if (size) {
    data = (atlas_msgs__srv__MotionRequest_Response *)allocator.zero_allocate(size, sizeof(atlas_msgs__srv__MotionRequest_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = atlas_msgs__srv__MotionRequest_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        atlas_msgs__srv__MotionRequest_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
atlas_msgs__srv__MotionRequest_Response__Sequence__fini(atlas_msgs__srv__MotionRequest_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      atlas_msgs__srv__MotionRequest_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  atlas_msgs__srv__MotionRequest_Response__Sequence * array = (atlas_msgs__srv__MotionRequest_Response__Sequence *)allocator.allocate(sizeof(atlas_msgs__srv__MotionRequest_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = atlas_msgs__srv__MotionRequest_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
atlas_msgs__srv__MotionRequest_Response__Sequence__destroy(atlas_msgs__srv__MotionRequest_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    atlas_msgs__srv__MotionRequest_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
atlas_msgs__srv__MotionRequest_Response__Sequence__are_equal(const atlas_msgs__srv__MotionRequest_Response__Sequence * lhs, const atlas_msgs__srv__MotionRequest_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!atlas_msgs__srv__MotionRequest_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  atlas_msgs__srv__MotionRequest_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(atlas_msgs__srv__MotionRequest_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    atlas_msgs__srv__MotionRequest_Response * data =
      (atlas_msgs__srv__MotionRequest_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!atlas_msgs__srv__MotionRequest_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          atlas_msgs__srv__MotionRequest_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!atlas_msgs__srv__MotionRequest_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
