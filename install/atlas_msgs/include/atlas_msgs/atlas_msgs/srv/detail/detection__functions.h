...
#ifndef ATLAS_MSGS__SRV__DETAIL__DETECTION__FUNCTIONS_H_
#define ATLAS_MSGS__SRV__DETAIL__DETECTION__FUNCTIONS_H_
 ...
 * calls
 * atlas_msgs__srv__Detection_Request__init().
...
/**
 * It calls
 * atlas_msgs__srv__Detection_Request__fini()
 ...
 * atlas_msgs__srv__Detection_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * atlas_msgs__srv__Detection_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * atlas_msgs__srv__Detection_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_atlas_msgs
...
/**
 * It calls
 * atlas_msgs__srv__Detection_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_atlas_msgs
...
/**
 * It allocates the memory for the array and calls
 * atlas_msgs__srv__Detection_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_atlas_msgs
...
/**
 * It calls
 * atlas_msgs__srv__Detection_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ATLAS_MSGS__SRV__DETAIL__DETECTION__FUNCTIONS_H_
